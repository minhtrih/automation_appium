...
const DEFAULT_ANDROID_DEVICE_NAME = process.env.SAUCE_LABS ? 'Android GoogleAPI Emulator' : '192.168.56.101:5555';
...
const LOCAL_ASSET_BASE = path.resolve(__dirname, '..', '..', '..', 'automation_sendo/appAPK');
...
if (SAUCE_TESTING) {
  ...
  androidApiDemos = path.resolve(LOCAL_ASSET_BASE, 'Sendo_App_v4.0.14_apkpure.com.apk');
}
